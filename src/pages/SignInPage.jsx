...
// Using an absolute path from the project's 'src' root for reliability
import sahayLogoDark from '/src/assets/sahay-logo-dark.png';
...
const SignInPage = ({ isDarkMode, onSwitchToSignUp, onSuccessfulLogin }) => {
  const styles = {
    ...
    submitButton: {
      ...
      // --- CHANGE: Text now inverts in dark mode for readability ---
